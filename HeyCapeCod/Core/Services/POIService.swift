...
enum TourTheme: String, CaseIterable, Identifiable {
    case pirate, haunted, maritime, foodie, romantic, nature
    case history, photography, family, art, adventure, explore
...
enum TourDuration: String, CaseIterable, Identifiable {
    case quick, halfDay, fullDay, multiDay
...
enum TourGeneratorError: LocalizedError {
    case apiError, parseError, noStopsFound
