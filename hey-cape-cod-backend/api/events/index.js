...
// ---------------------------------------------------------------------------
// Hardcoded Cape Cod Events (MVP — 50+ events, 2026 season)
// ---------------------------------------------------------------------------

function getHardcodedEvents() {
  return [
    {
      id: 'wellfleet-oysterfest-2026',
    ...
    },
    {
      ...
      recurringEndDate: '2026-09-05',
    },
    {
      id: 'barnstable-county-fair-2026',
    ...
    {
      id: 'harwich-cranberry-festival-2026',
    ...
    },
    {
      ...
      isRecurring: true,
      recurrenceRule: 'weekly',
      recurringEndDate: '2026-10-09',
    },
    {
      id: 'wellfleet-drivein-2026',
    ...
    },
    {
      ...
      isRecurring: true,
      recurrenceRule: 'weekly',
      recurringEndDate: '2026-09-27',
    },
    {
      id: 'nauset-lighthouse-tour-2026',
    ...
    {
      id: 'highland-lighthouse-tour-2026',
    ...
    {
      id: 'sandwich-glass-museum-demo-2026',
    ...
    {
      id: 'cape-cod-baseball-league-2026',
    ...
    },
    {
      ...
      isRecurring: true,
      recurrenceRule: 'weekly',
      recurringEndDate: '2026-09-28',
    },
    {
      id: 'mashpee-wampanoag-powwow-2026',
    ...
    {
      id: 'cape-cod-st-patricks-parade-2026',
    ...
    {
      id: 'sandwich-spring-fling-2026',
      name: 'Sandwich Spring Fling',
      description: 'Welcome spring on Cape Cod with a town-wide celebration featuring craft vendors, live music, a kids\' fun zone, and the famous Sandwich boardwalk walk. Local restaurants offer special menus.',
      date: '2026-03-28',
      endDate: '2026-03-29',
      time: '10:00 AM - 4:00 PM',
      location: 'Town Hall Square, Sandwich',
      town: 'Sandwich',
      category: 'festivals',
      venue: 'Sandwich Town Hall Square',
      imageUrl: null,
      website: null,
      isFree: true,
      price: null,
    ...
    {
      id: 'cc-museum-trail-month-2026',
      name: 'Cape Cod Museum Trail Month',
      description: 'All month long, Cape Cod museums offer special events, free admission days, behind-the-scenes tours, and family programs. Pick up a Museum Trail passport and visit them all!',
      date: '2026-04-01',
      endDate: '2026-04-30',
      time: 'Varies',
      location: 'Various museums across Cape Cod',
      town: 'Barnstable',
      category: 'family',
      venue: 'Cape Cod Museum Trail',
      imageUrl: null,
      website: 'https://www.capecodmuseumtrail.com',
      isFree: false,
    ...
    {
      id: 'dennis-run-for-arts-2026',
      name: 'Dennis 5K Run for the Arts',
      description: 'Annual 5K road race through scenic Dennis Village supporting arts education. Post-race celebration with live music and local food. Runners and walkers welcome.',
      date: '2026-04-18',
      endDate: null,
      time: '9:00 AM',
      location: 'Dennis Village Green, Dennis',
      town: 'Dennis',
      category: 'sports',
      venue: 'Dennis Village Green',
      imageUrl: null,
      website: null,
      isFree: false,
    ...
    {
      id: 'herring-run-brewster-2026',
      name: 'Herring Run at Stony Brook',
      description: 'Witness the annual herring run at Stony Brook Grist Mill in Brewster. Thousands of river herring migrate upstream each spring — a spectacular natural event. Rangers on-site for questions.',
      date: '2026-04-01',
      endDate: '2026-05-15',
      time: 'Dawn to dusk',
      location: 'Stony Brook Road, Brewster',
      town: 'Brewster',
      category: 'family',
      venue: 'Stony Brook Grist Mill',
      imageUrl: null,
      website: 'https://www.ccmnh.org',
      isFree: true,
      price: null,
    ...
    {
      id: 'daffodil-festival-nantucket-2026',
      name: 'Cape & Islands Daffodil Festival',
      description: 'Millions of daffodils bloom across Cape Cod in late April. Garden tours, flower shows, and the famous antique car parade through Nantucket-inspired decorated towns.',
      date: '2026-04-25',
      endDate: '2026-04-26',
      time: '10:00 AM - 4:00 PM',
      ...
      town: 'Barnstable',
      category: 'festivals',
      venue: 'Various Cape Cod gardens',
      imageUrl: null,
      website: null,
      isFree: true,
      price: null,
    ...
    {
      id: 'cc-st-patricks-5k-2026',
      name: 'Cape Cod St. Patrick\'s Day 5K',
      description: 'Festive 5K run/walk in Yarmouth celebrating St. Patrick\'s Day. Costumes encouraged! Post-race party with Irish music and refreshments.',
      date: '2026-03-14',
      endDate: null,
      time: '10:00 AM',
      location: 'Route 28, Yarmouth',
    ...
    {
      id: 'whale-watching-season-opener-2026',
      name: 'Whale Watching Season Opening',
      description: 'The first whale watching trips of the season depart from Provincetown\'s MacMillan Wharf. Humpback and right whales return to Cape Cod Bay. Book early — trips sell out fast!',
      date: '2026-04-04',
      endDate: null,
      time: '10:00 AM & 1:30 PM',
      location: 'MacMillan Wharf, Provincetown',
      town: 'Provincetown',
      category: 'family',
      venue: 'Dolphin Fleet Whale Watch',
      imageUrl: null,
      website: 'https://www.whalewatch.com',
      isFree: false,
      price: '$62 adults, $38 children',
      isRecurring: false,
      recurrenceRule: null,
      recurringEndDate: null,
    },
    {
      id: 'spring-bird-migration-walk-2026',
      name: 'Spring Bird Migration Walk',
      description: 'Join Mass Audubon naturalists for guided birding walks at Wellfleet Bay Wildlife Sanctuary. Spring migration brings warblers, shorebirds, and raptors through Cape Cod.',
      date: '2026-04-11',
      endDate: null,
      time: '7:00 AM - 10:00 AM',
      location: '291 State Highway Route 6, Wellfleet',
      town: 'Wellfleet',
      category: 'family',
      venue: 'Wellfleet Bay Wildlife Sanctuary',
      imageUrl: null,
      ...
      isRecurring: true,
      recurrenceRule: 'weekly',
      recurringEndDate: '2026-05-30',
    },
    {
      id: 'eastham-windmill-weekend-2026',
